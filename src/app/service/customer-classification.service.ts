...
export class CustomerClassificationService {
    ...
    public getCustomerClassification(params: any): Observable<TypeData<CustomerClassification>> {
    ...
    public getAllCustomerClassification(): Observable<TypeData<CustomerClassification>> {
    ...
    public deleteCustomerClassification(id: number): Observable<CustomerClassification | null> {
        const url: string = `${_prefix}/${id}`;

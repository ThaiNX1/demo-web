...
export class IncomingTextService {
    ...
    public getPagingIncomingText(params: any): Observable<TypeData<IncomingTextModel>> {
    ...
    public createIncomingText(incomingText: IncomingTextModel): Observable<IncomingTextModel | null> {
    ...
    public updateIncomingText(incomingText: IncomingTextModel, id: number): Observable<IncomingTextModel> {
        const url: string = `${_prefix}/${id}`;
    ...
    public deleteIncomingText(id: number): Observable<IncomingTextModel | null> {
        const url: string = `${_prefix}/${id}`;

...
import {Degree, Department, Document, Position, Target } from '../models/document.model';
...
export class DocumentService {
    ...
    public getPositionList():  Observable<TypeData<Position> | null>{
        return this.httpClient.get(`${this._baseUrl}/PositionDetails/list`, {}).pipe(
    ...
    public getDepartmentList():  Observable<TypeData<Department> | null>{
        return this.httpClient.get(`${this._baseUrl}/Departments/list`, {}).pipe(

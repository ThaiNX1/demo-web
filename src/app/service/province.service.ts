...
let _prefix = `${AppConstant.DEFAULT_URLS.API}/Province`;
...
export class ProvinceService {
    ...
    public getProvinceDetail(id: number): Observable<Province> {
    ...
    public updateProvince(province: Province,id: number): Observable<Province> {
        const url: string = `${_prefix}/${id}`;

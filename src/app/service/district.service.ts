...
let _prefix = `${AppConstant.DEFAULT_URLS.API}/District`;
...
export class DistrictService {
    ...
    public getPagingDistrict(
        params: any
    ): Observable<TypeData<District>> {
    ...
    public getDistrictDetail(id: number): Observable<District> {
    ...
    importExcel(formData): Observable<any> {
        return this.httpClient
            .post(`/api/District/import-bkhh`, formData)
            .pipe(
                map((data: any) => {
                    return data;
                })

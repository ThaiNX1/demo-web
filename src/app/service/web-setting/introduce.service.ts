...
export class IntroduceService {
    ...
    public getPagingIntroduce(params: any): Observable<TypeData<IntroduceModel>> {
    ...
    public createIntroduce(textGo: IntroduceModel): Observable<IntroduceModel | null> {
    ...
    public updateIntroduce(Introduce: IntroduceModel, id: number): Observable<IntroduceModel> {
        const url: string = `${_prefix}/${id}`;

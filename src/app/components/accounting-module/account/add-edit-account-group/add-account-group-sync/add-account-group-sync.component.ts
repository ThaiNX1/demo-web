...
@Component({
  ...
  styleUrls: ['./add-account-group-sync.component.scss']
})
export class AddAccountGroupSyncComponent extends AppComponentBase implements OnInit {
  ...
  onAdd() {
    if (this.formGroup.valid) {
      const input = new AccountGroupSyncModel(this.formGroup.getRawValue());

...
export class RelativesFormComponent {
    ...
    ngOnChanges(changes: SimpleChanges): void {
        if (
            ...
            // )?.id;
            this.relativeForm.setValue({
                id: this.formData.id ?? null,
                status: this.formData.status ?? null,
                fullName: this.formData.fullName ?? null,
                phone: this.formData.phone ?? null,
                birthday:
                    moment(this.formData.birthday).format(
                        this.appConstant.FORMAT_DATE.VN_DATE_PIPE_SHORT_DATE
                    ) ?? null,
                // code: this.formData.code ?? null,
                provinceId: this.formData.provinceId ?? null,
                districtId: this.formData.districtId ?? null,
                wardId: this.formData.wardId ?? null,
                gender: this.formData.gender ?? null,
                email: this.formData.email ?? null,
                address: this.formData.address ?? null,
                identify: this.formData.identify ?? null,
                identifyCreatedDate:
                    moment(this.formData.identifyCreatedDate).format(
                        this.appConstant.FORMAT_DATE.VN_DATE_PIPE_SHORT_DATE
                    ) ?? null,
                identifyCreatedPlace:
                    this.formData.identifyCreatedPlace ?? null,
                identifyExpiredDate:
                    moment(this.formData.identifyExpiredDate).format(
                        this.appConstant.FORMAT_DATE.VN_DATE_PIPE_SHORT_DATE
                    ) ?? null,
                nativeProvinceId: this.formData.nativeProvinceId ?? null,
                nativeDistrictId: this.formData.nativeDistrictId ?? null,
                nativeWardId: this.formData.nativeWardId ?? null,
                placeOfPermanent: this.formData.placeOfPermanent ?? null,
                ethnicGroup: this.formData.ethnicGroup ?? null,
                nation: this.formData.nation ?? null,
                religion: this.formData.religion ?? null,
                unionMember: this.formData.unionMember ?? null,
                literacy: this.formData.literacy ?? null,
                literacyDetail: this.formData.literacyDetail ?? null,
                // majorId: this.formData.majorId ?? null,
                certificate: this.formData.certificate ?? null,
                avatar: this.formData.avatar ?? null,
                specialize: this.formData.specialize ?? null,
                nativePlace: this.formData.nativePlace ?? null,
                code: this.formData.code ?? null,
            });
